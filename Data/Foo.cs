...
namespace BootstrapBlazorApp2.Server.Data
{
    ...
    public class Foo
    {
        ...
        public Foo FooTeste { get; set; }

        public string? ValueCascadeRoot { get; set; }

        public string? ValueMultiselect { get; set; }

        public TreeFoo? ValueTreeFoo { get; set; }

        public bool? ValueNullSwitch { get; set; }

        public string? ValueTipoPessoa { get; set; }

        public string? ValueSubTipoPessoa { get; set; }

        public string? ValueAnexoRelatorio { get; set; }
